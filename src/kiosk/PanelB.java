...
*/   
   JButton btn1 = new JButton("짜장면",new ImageIcon("src\\kiosk\\imgs\\1.PNG"));
   JButton btn2 = new JButton("짬뽕",new ImageIcon("src\\kiosk\\imgs\\2.PNG"));
   JButton btn3 = new JButton("탕수육",new ImageIcon("src\\kiosk\\imgs\\3.PNG"));
   JButton btn4 = new JButton("군만두",new ImageIcon("src\\kiosk\\imgs\\4.PNG"));
   JButton btn5 = new JButton("꿔바로우",new ImageIcon("src\\kiosk\\imgs\\5.PNG"));
   JButton btn6 = new JButton("울면",new ImageIcon("src\\kiosk\\imgs\\6.PNG"));
