...
public class PanelC extends JPanel{
   ...
   //직접 객체 생성
   JButton btn1 = new JButton("초밥",new ImageIcon("src\\kiosk\\imgs\\1.PNG"));
   JButton btn2 = new JButton("돈까스",new ImageIcon("src\\kiosk\\imgs\\2.PNG") );
   JButton btn3 = new JButton("카레", new ImageIcon("src\\kiosk\\imgs\\3.PNG"));
   JButton btn4 = new JButton("우동",new ImageIcon("src\\kiosk\\imgs\\4.PNG"));
   JButton btn5 = new JButton("텐동", new ImageIcon("src\\kiosk\\imgs\\5.PNG"));
   JButton btn6 = new JButton("라멘",new ImageIcon("src\\kiosk\\imgs\\6.PNG"));
